                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-xl p-8 mb-8 shadow-lg">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="border-l-4 border-blue-500 pl-4">
                                ...
                                <p className="text-gray-600"><a href="https://hmei.info/"  className="hover:text-blue-300 text-blue-600" target="_blank">  Hiranmayi Educational Institue </a>  • May 2025 - Present</p>
                                <p className="text-gray-600 mt-2">
